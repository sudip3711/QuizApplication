...
//       // No automatic navigation - stays on current page
//     }
...
//           `http://localhost:8080/quiz/get/particular/${id}`,
//           {
//             headers: {
...
//   return (
//     <div className="max-w-sm mx-auto mt-10 rounded overflow-hidden shadow-lg bg-white p-4">
//       <div className="px-6 py-4">
//         <h1 className="font-bold text-xl mb-2">{quiz.title || 'Untitled Quiz'}</h1>
//       </div>
//       <div className="px-6 pt-2 pb-4 flex justify-between items-center">
//         <span className="text-gray-600 text-sm">
//           {quiz.createdDate ? new Date(quiz.createdDate).toLocaleDateString() : 'No date'}
//         </span>
//         <button 
